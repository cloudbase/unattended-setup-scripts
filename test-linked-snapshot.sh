...
ssh apilotti@10.7.2.2 /vmfs/volumes/ssd1/unattended-scripts/create-esxi-vm.sh $DATASTORE rhel6-64 "$VM_NAME" $POOL_NAME 1024 2 2 - /vmfs/volumes/ssd1/centos-6.4-template/centos-6.4-template.vmdk - - - false $NET_ADAPTER_TYPE false "VM Network"
